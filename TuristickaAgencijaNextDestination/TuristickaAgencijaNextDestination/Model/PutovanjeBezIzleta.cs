...
namespace TuristickaAgencijaNextDestination.Model
{
    public class PutovanjaBezIzleta:Putovanje
    {
        ...
        public static void ubaciPutovanjaBezIzletaUBazu()
        {
            ...
            upisPutovanjaBezIzletaUBazu("Spanija", 10, date11.ToString(), date12.ToString(),
                ...
                4, PrevoznoSredstvo.autobus, PutnoOsiguranje.TriglavOsiguranje, 6);
        }
            ...
            PutnoOsiguranje putnoOsiguranje, int id)
        {
            ...
            MySqlCommand insertUpit = new MySqlCommand("insert into putovanjabezizleta(destinacija, cijena, datumPolaska, datumDolaska, trajanjePutovanja, brojSlobodnihMjesta, prevoznoSredstvo, putnoOsiguranje, id) values ('" 
        ...
        */
        ...
        public static void upisPredlozenogPutovanjaBezIzletaUBazu(string destinacija, double cijena,
            string datumPolaska, string datumDolaska, int trajanjePutovanja,
            int brojSlobodnihMjesta, PrevoznoSredstvo prevoznoSredstvo,
            PutnoOsiguranje putnoOsiguranje, int id)
        {
            ...
            MySqlCommand insertUpit = new MySqlCommand("insert into predlozenaputovanjabezizleta(destinacija, cijena, datumPolaska, datumDolaska, trajanjePutovanja, brojSlobodnihMjesta, prevoznoSredstvo, putnoOsiguranje, id) values ('"
                + destinacija + "','" + cijena + "','" + datumPolaska + "','" + datumDolaska + "','"
                + trajanjePutovanja + "','" + brojSlobodnihMjesta + "','" + prevoznoSredstvo.ToString()
                + "','" + putnoOsiguranje.ToString() + "','" + id + "')", msc);
        ...
        public static void ucitajPredlozenoPutovanjeBezIzletaUListu()
        {
            Model.PutovanjaBezIzleta.listaPredlozenihPutovanjaBezIzleta.Clear();
            ...
            MySqlCommand upitKomanda = new MySqlCommand("select * from predlozenaputovanjabezizleta", con);
            MySqlDataReader r = upitKomanda.ExecuteReader();
            while (r.Read())
            {
                Model.PutovanjaBezIzleta.listaPredlozenihPutovanjaBezIzleta.Add(new PutovanjaBezIzleta(r.GetString("destinacija"),
                    r.GetDouble("cijena"), r.GetString("datumPolaska"), r.GetString("datumDolaska"),
                    r.GetInt32("trajanjePutovanja"), r.GetInt32("brojSlobodnihMjesta"),
                    r.GetString("prevoznoSredstvo"), r.GetString("putnoOsiguranje"), r.GetInt32("id")));
            }
        ...
        public static void obrisiPredlozenoPutovanjeIzBaze(string _destinacija)
        {
            string username = "root";
            string password = "";
            string db = "turistickaagencija";
