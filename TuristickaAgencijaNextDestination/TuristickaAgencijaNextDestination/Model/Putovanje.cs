...
namespace TuristickaAgencijaNextDestination.Model
{
    ...
    public class Putovanje
    {
        ...
        public Putovanje() { }
        public Putovanje (int id,string destinacija,double cijena,DateTime datumPolaska,DateTime datumDolaska,int trajanjePutovanja,int brojSlobodnihMjesta,PrevoznoSredstvo prevoznoSredstvo,PutnoOsiguranje putnoOsiguranje)
        {
            this.id = id;
